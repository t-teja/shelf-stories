...
function itemToDraft(item?: CollectionItem | null, initialWant = false): Draft {
  if (!item) {
    return {
      ...
      price: '', purchasedFrom: '', productLink: '', quantity: '1',
    };
  }
  return {
    name: item.name,
...
export function AddItemModal({
  ...
  const submit = (e: React.FormEvent) => {
    ...
    if (priceRaw !== '' && (Number.isNaN(priceNum!) || priceNum! < 0)) return;
    ...
    const item: CollectionItem = {
      ...
      price: priceNum,
      purchasedFrom: draft.purchasedFrom.trim() || undefined,
      productLink: draft.productLink.trim() || undefined,
      quantity: qty,
        ...
        <form onSubmit={submit} className="space-y-4 p-4 sm:p-6">
          ...
          <div className="grid gap-3 sm:grid-cols-4">
            ...
            <label className={labelClass}>
              Purchased from
              <input
                value={draft.purchasedFrom}
                onChange={(e) => setDraft({ ...draft, purchasedFrom: e.target.value })}
                className={fieldClass}
            ...
            <label className={labelClass}>
              ...
              <input
                ...
                onChange={(e) => setDraft({ ...draft, acquiredAt: e.target.value })}
                className={fieldClass}
              />
            </label>
          </div>
          ...
          <label className={labelClass}>
            ...
            <input
              ...
              onChange={(e) => setDraft({ ...draft, productLink: e.target.value })}
              className={fieldClass}
              placeholder="https://…"
            />
          </label>
